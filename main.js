...
mobile: MethodMobile, 
browser: opcion == '1' ? ['M', 'Edge', stichbot'2.0.0'] : methodCodeQR ? ['stichbot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
let prekey = []
let directorio = readdirSync("./MonkeySession")
