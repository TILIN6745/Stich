...
conn.reply(m.chat, `${lenguajeGB['smsAvisoIIG']()}${mid.smsinfo}`, m, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: '𝑴𝑶𝑵𝑲𝑬𝒀 𝑩𝑶𝑻 | 𝑴𝑶𝑵𝑲𝑬𝒀 𝑩𝑶𝑻', body: 'Super Bot WhatsApp',          previewType: 0, thumbnail: gataMenu, sourceUrl: md}}})
}} catch (e) {
